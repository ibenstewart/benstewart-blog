export const metadata = {
  ...
  description: "How I use AI to stress-test my thinking before it reaches a room full of people who won't push back hard enough.",
  openGraph: {
    title: "I Built a System Where AI Agents Argue About Strategy",
    description: "How I use AI to stress-test my thinking before it reaches a room full of people who won't push back hard enough.",
    url: "https://www.benstewart.ai/posts/thinking-engine",
    images: [{
      url: "https://www.benstewart.ai/images/posts/thinking-engine-0.png",
      width: 1200,
      height: 630,
    }],
  }
...
**What in this analysis surprised you?** If the answer is nothing, the system just confirmed what I already believed. It says so, explicitly. "This analysis reinforced your existing position. Consider whether you posed the question in a way that invited genuine challenge."
...
Here's where it gets useful. When I ran an analysis on product strategy, the antifragility agent's analysis was terrifying in the agent economy reality (your revenue model breaks suddenly, not gradually) yet largely irrelevant in the status quo reality. That delta; the gap between "existential threat" and "doesn't matter;" is exactly the kind of information you can't see without the framework.
