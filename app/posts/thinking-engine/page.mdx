...
Here's why I built it: most strategic thinking inside companies follows a predictable path. Someone poses a question, the most senior person offers their frame, and the group gravitates toward it. You get one lens, one set of assumptions, and because the person talking usually has a decent track record, nobody pushes back hard enough.
...
3. **A synthesis step identifies where they disagree first, then where they agree.** Because consensus is easy. Tension is where you learn something.

4. **Before anything gets saved, I have to answer three questions** that keep the whole thing honest. More on that in a minute.

## Why personas, not prompts

You could just ask Claude to think about something from multiple perspectives, but you'll get a polite, balanced, hedged answer where everything feels reasonable and nothing is uncomfortable.
...
After a few months of use, the system has accumulated a body of company-specific strategic knowledge that makes every analysis more grounded and less generic. Generic strategy advice is useless and everyone knows that, but the compounding system tilts toward specificity over time, which is where the real value lives.
