...
This is the same idea behind [shared documents not being shared understanding](/posts/shared-documents-are-not-shared-understanding); the document itself is never the whole story. The question isn't "did I write it clearly?" It's "does this need to exist in this form at all?"
