export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.benstewart.ai/posts/meeting-rooms-are-now-free'
  },
  openGraph: {
    ...
    images: [{
      url: "/images/posts/meeting-rooms-are-now-free-0.jpg",
      width: 1200,
      height: 630,
    }],
  }
...
<PostSchema
  ...
  description="The pandemic eliminated meeting room scarcity—now your company has as many rooms as you have calendar slots. But are you using them wisely? Learn how to battle calendar bloat and protect your time in a world where meetings are frictionless."
  date="2023-09-18"
  slug="meeting-rooms-are-now-free"
  image="https://www.benstewart.ai/images/posts/meeting-rooms-are-now-free-0.jpg"
/>

![Calendar full of back-to-back video meetings](/images/posts/meeting-rooms-are-now-free-0.jpg)
...
<PostNav slug="meeting-rooms-are-now-free" />
