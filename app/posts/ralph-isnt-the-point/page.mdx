export const metadata = {
  title: "AI Coding Tools and PRDs: Why the Spec Is the Real Work",
  date: "2025-01-09",
...
<PostNav slug="ralph-isnt-the-point" related={["multi-agent-ai-strategy", "sustainable", "the-ideal-senior-engineer"]} />
