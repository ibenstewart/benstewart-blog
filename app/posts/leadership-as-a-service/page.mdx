export const metadata = {
  ...
  description: "Software is easy; humans are hard. Discover a practical leadership toolkit including 1-1s, documentation, W.A.I.S.T., empathy, saying no, and the power of time. Learn how to approach people problems with the same systematic thinking you use for technical challenges.",
  alternates: {
    canonical: 'https://www.benstewart.ai/posts/leadership-as-a-service'
  },
  openGraph: {
    title: "Leadership as a Service - Your toolkit for solving people problems",
    description: "Software is easy; humans are hard. Discover a practical leadership toolkit including 1-1s, documentation, W.A.I.S.T., empathy, saying no, and the power of time. Learn how to approach people problems with the same systematic thinking you use for technical challenges.",
    url: "https://www.benstewart.ai/posts/leadership-as-a-service",
    images: [{
      url: "/images/posts/leadership-as-a-service-0.png",
      width: 1200,
      height: 630,
    }],
  }
...
<PostSchema
  ...
  image="https://www.benstewart.ai/images/posts/leadership-as-a-service-0.png"
/>

![Leadership toolkit illustration with various management tools](/images/posts/leadership-as-a-service-0.png)
...
<PostNav slug="leadership-as-a-service" />
