export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.benstewart.ai/posts/shared-documents-are-not-shared-understanding'
  },
  openGraph: {
    title: "Shared Documents Are Not Shared Understanding",
    description: "A document describes what someone wants but misses the context: rejected alternatives, unstated assumptions, obvious-but-unwritten constraints. The fix is shorter feedback loops—check in constantly, show work early, clarify before you build. Five minutes of conversation beats fifty pages.",
...
<PostSchema
  ...
  description="A document describes what someone wants but misses the context: rejected alternatives, unstated assumptions, obvious-but-unwritten constraints. The fix is shorter feedback loops—check in constantly, show work early, clarify before you build. Five minutes of conversation beats fifty pages."
  date="2016-01-10"
  slug="shared-documents-are-not-shared-understanding"
...
<PostNav slug="shared-documents-are-not-shared-understanding" />
