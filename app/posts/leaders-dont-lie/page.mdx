export const metadata = {
  title: "Leaders Don't Lie: How to Report Project Status Honestly",
  date: "2023-09-18",
...
<FAQJsonLd faqs={[
  {
    question: "What is the watermelon effect in project management?",
    answer: "The watermelon effect describes a project that looks green on the outside (status reports say all is fine) but is red on the inside (things are actually going wrong). It usually surfaces two weeks before go-live when a critical problem can no longer be hidden."
  },
  {
    question: "Why do leaders lie about project status?",
    answer: "The most common reason is ego — admitting a project is in trouble feels like admitting personal failure. Engineers and leaders often believe they can recover the situation before anyone needs to know, which delays intervention and makes the eventual problem worse."
  },
  {
    question: "How should a leader report a project that is behind schedule?",
    answer: "Report amber or red status as soon as you know it, not when you're forced to. Give the facts: what's slipped, why, and what you're doing about it. An early amber status gives the organisation time to respond. A late red status after weeks of fake green destroys trust."
  }
]} />
...
## The ego problem: why leaders hide the truth
...
<PostNav slug="leaders-dont-lie" related={["the-ideal-senior-engineer", "shared-documents-are-not-shared-understanding", "practical-postmortems"]} />
