export const metadata = {
  title: "What a Great Senior Engineer Actually Looks Like",
  date: "2023-09-18",
...
<FAQJsonLd faqs={[
  {
    question: "What makes a great senior engineer?",
    answer: "A great senior engineer is a multiplier, not a bottleneck or a superhero. They coach as much as they code, actively mentor engineers outside their own team, prioritise code reviews over their own work, and constantly question whether the team is spending time on the most impactful things. Technical skill matters, but leverage and judgment matter more at this level."
  },
  {
    question: "Should engineers become managers or stay on the IC track?",
    answer: "Neither path is inherently better, but the 'make before you manage' principle is worth taking seriously. Building things and shipping them to customers gives you a foundation that leadership theory alone cannot. The best time to consider moving into management is after you've spent years building at scale — not before."
  },
  {
    question: "What is the biggest difference between a mid-level and senior engineer?",
    answer: "The jump from mid-level to senior is larger than most career ladders make it look. A senior engineer is expected to operate independently across ambiguous problems, influence team direction, coach others, and think about what not to build — not just what to build. The output is measured in team impact, not personal velocity."
  }
]} />
...
## The career path to senior engineer
...
## What a high-performing senior engineer actually looks like
...
<PostNav slug="the-ideal-senior-engineer" related={["leaders-dont-lie", "ralph-isnt-the-point", "am-i-technically-dangerous"]} />
