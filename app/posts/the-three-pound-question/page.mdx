export const metadata = {
  ...
  description: "Three pounds for a getting-to-know-you conversation with Clawdbot taught me something about the shape of AI the industry isn't building yet. Reactive AI answers questions. What happens when AI starts asking them?",
  alternates: {
...
## Why No One's Ready (But Should Be Thinking About It)
