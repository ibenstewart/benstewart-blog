export const metadata = {
  title: "Reactive AI vs Proactive AI: What a £3 Clawdbot Experiment Revealed",
  date: "2026-01-26",
  subtitle: "What I learned from an expensive conversation with a chatbot",
  description: "Most AI tools wait to be asked. Clawdbot messages you first. A weekend experiment exposed the gap between reactive AI (a tool you pick up) and proactive AI (infrastructure that monitors and acts). Here's why that distinction matters for every engineering team.",
  alternates: {
    canonical: 'https://www.benstewart.ai/posts/the-three-pound-question'
  },
  openGraph: {
    title: "Reactive AI vs Proactive AI: What a £3 Clawdbot Experiment Revealed",
    description: "Most AI tools wait to be asked. Clawdbot messages you first. A weekend experiment exposed the gap between reactive AI (a tool you pick up) and proactive AI (infrastructure that monitors and acts). Here's why that distinction matters for every engineering team.",
    ...
    images: [{
      url: "/images/posts/the-three-pound-question-0.jpg",
      width: 1200,
      height: 630,
    }],
  }
...
<PostSchema
  ...
  description="Most AI tools wait to be asked. Clawdbot messages you first. A weekend experiment exposed the gap between reactive AI (a tool you pick up) and proactive AI (infrastructure that monitors and acts). Here's why that distinction matters for every engineering team."
  date="2026-01-26"
  slug="the-three-pound-question"
  image="https://www.benstewart.ai/images/posts/the-three-pound-question-0.jpg"
/>

<FAQJsonLd faqs={[
  {
    question: "What is the difference between reactive AI and proactive AI?",
    answer: "Reactive AI waits for you to ask a question and responds. Proactive AI monitors systems and surfaces problems or information before you ask. Most current AI tools (ChatGPT, Claude, Copilot) are reactive. Proactive AI acts more like infrastructure — it runs whether you're paying attention or not."
  },
  {
    question: "What is Clawdbot?",
    answer: "Clawdbot is an open-source AI assistant that messages you first rather than waiting to be invoked. It gained around 8,000 GitHub stars quickly. It stores memory as Markdown files (reversible with git revert), can extend its own skills, and delivers morning briefings and alerts via Telegram."
  },
  {
    question: "What would proactive AI look like for an engineering team?",
    answer: "An agent that understands your deployment pipelines, incident management, and team communication patterns — and messages you when something looks wrong rather than waiting for you to notice. For example: 'The deployment to staging has been stuck for 20 minutes. I've checked the logs — it's waiting on a database migration lock. Want me to investigate?'"
  }
]} />
...
<TLDR>
I spent £3 having a conversation with Clawdbot, an open-source AI assistant that messages you first instead of waiting to be asked. The cost model is broken and it's clearly a power-user toy, but it shows the shape of something the industry isn't building yet: proactive AI that monitors your systems and surfaces problems before you look. Reactive AI is a tool. Proactive AI is infrastructure. The question isn't whether this happens, it's whether you'll be ready when it does.
</TLDR>
...
The industry has been conditioned to think of AI as reactive because that's what the tools do: you go to ChatGPT, you invoke Claude, you prompt Copilot, and the mental model is always "I initiate, AI responds." That mental model is about to flip.

---

## Reactive AI vs proactive AI: why the mental model is about to flip
...
The industry has built decades of infrastructure that's entirely reactive: alerts that fire after thresholds are breached, monitoring dashboards you have to check, logs you have to grep. This has been normalised because that's what was possible.
...
<PostNav slug="the-three-pound-question" related={["multi-agent-ai-strategy", "sustainable", "ralph-isnt-the-point"]} />
